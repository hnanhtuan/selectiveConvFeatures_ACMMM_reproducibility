...
if exist('results/exp6_table6_compare_SOTA_results.mat', 'file')
    load('results/exp6_table6_compare_SOTA_results.mat');
else
...
for dataset_idx=1:length(datasets)
    ...
    for mask_method_idx=1:length(mask_methods)
        ...
        for final_dim_idx=1:length(final_dims)
            ...
            % for 4096-D, only conduct experiments for MAX-mask
    ...
    save('results/exp6_table6_compare_SOTA_results.mat', ...
                        'mAPs', 'datasets', 'mask_methods', 'final_dims');
end
print_table6_compare_SOTA_part1;
