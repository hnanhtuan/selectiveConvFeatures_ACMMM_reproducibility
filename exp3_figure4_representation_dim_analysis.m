...
if (exist('results/exp3_figure4_representation_dim_analysis.mat', 'file'))
    load('results/exp3_figure4_representation_dim_analysis.mat');
else
...
for dataset_idx=1:length(datasets)
    ...
    for mask_method_idx=1:length(mask_methods)
        ...
        for final_dim_idx=1:length(final_dims)
            ...
            save('results/exp3_figure4_representation_dim_analysis.mat', ...
                                'mAPs', 'datasets', 'mask_methods', 'final_dims');
        end
    end
    plot_figure4_representation_dim_analysis;
end
