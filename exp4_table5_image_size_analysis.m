...
if exist('results/exp4_table5_image_size_analysis_results.mat', 'file')
    load('results/exp4_table5_image_size_analysis_results.mat');
else
...
for dataset_idx=1:length(datasets)
    ...
    for mask_method_idx=1:length(mask_methods)
        ...
        for max_img_dim_idx=1:length(max_img_dims)
            ...
            if (mAPs(dataset_idx, mask_method_idx, max_img_dim_idx) > 0)
                continue;
            end
            
            lid             = 31;       % index of output layer of VGG network
            param.d         = 32;       % final dimensionality: 512-D
            param.k         = 20;  
            ...
            save('results/exp4_table5_image_size_analysis_results.mat', ...
                            'mAPs', 'datasets', 'mask_methods', 'max_img_dims');
        end
    end
end
print_table5_image_size_analysis;
