...
if exist('results/exp5_figure5_conv_layer_analysis.mat', 'file')
    load('results/exp5_figure5_conv_layer_analysis.mat');
else
...
for dataset_idx=1:length(datasets)
    ...
    for lid_idx=1:length(lids)
        ...
        for final_dim_idx = 1:length(final_dims)
            ...
            if (mAPs(dataset_idx, lid_idx, final_dim_idx) > 0)
                continue;
            end
            ...
            save('results/exp5_figure5_conv_layer_analysis.mat', 'mAPs', 'datasets', 'lids');
        end
    end    
    plot_figure5_conv_layers_analysis;
end